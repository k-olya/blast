...
export function createTexture(gl, glTexture, width, height, options = null) {
  const opts = {
    framebuffer: null,
    pixels: null,
    minFilter: gl.LINEAR,
...
export function createVertexBuffer(gl, vertices = defaultVertices) {
...
export function enableVertexBuffer(gl, attribLocation, options = null) {
  const opts = {
    buffer: null,
    size: 2,
    ...options,
...
// fill entire screen
export function fillFramebuffer(gl, width, height, framebuffer = null) {
